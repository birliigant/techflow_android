...
本项目以 [docs/接口文档.md](docs/接口文档.md) 为主要后端接口依据，围绕「提问、浏览、详情、回答、用户主页、标签、个人资料」等核心场景，使用现代 Android 技术栈完成了一套可运行、可扩展、可持续演进的 Compose 客户端。
...
- `MMKV`：保存 access token、当前用户信息、基础服务地址配置等轻量状态
